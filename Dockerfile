...
RUN \
  apt-get -y --no-install-recommends install install -y unzip netcdf-devel libxml2-devel ImageMagick graphviz cairo-devel libXt-devel 
...
# This installs R packages from Bioconductor
